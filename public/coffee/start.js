...
(function() {
  $(function() {
    var $canvas, $game, $level, $levels, $moves, $next, $play, $pushes, $set, $sets, btns, completed_level, current, done, fn, get_lvl, j, k, kc, len, level_completed, levels, next_level, on_done, on_update, oops, opts, play, quit, ref, scroll_to_center, set_levels, set_lvl, start, v, x;
    $sets = $('#sets');
    $levels = $('#levels');
    $play = $('#play');
    $next = $('#next');
