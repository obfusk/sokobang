...
(function() {
  var B, S, U, data_to_world, defaults, goals_reached, img_and_scene, img_list_and_scene, is_dir, move, move_man, move_man_click, place_goals, place_man, place_objects, place_walls, posn_str, posn_to_canvas_xy, posn_to_canvas_xy_scaled, render_end, render_world, sorted_positions, start, update_world,
    slice = [].slice;
  ...
  S.move_man_click = move_man_click = function(w, x, y) {
    var dx, dy, man_x, man_y, ref, ref1;
    ref = posn_to_canvas_xy_scaled(w.man, w.opts), man_x = ref[0], man_y = ref[1];
    ref1 = [x - man_x, y - man_y], dx = ref1[0], dy = ref1[1];
