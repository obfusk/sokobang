...
(function() {
  var B, S, U, data_to_world, defaults, goals_reached, img_and_scene, img_list_and_scene, is_dir, move, move_man, place_goals, place_man, place_objects, place_walls, posn_str, render_end, render_world, sorted_positions, start, update_world;
  ...
  S.img_and_scene = img_and_scene = function(posn, img, opts, scene) {
    return B.place_image(img, posn.x * opts.img_size + opts.img_size / 2, posn.y * opts.img_size + opts.img_size / 2, scene);
  };
